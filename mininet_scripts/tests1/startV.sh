...
sudo python2.7 /home/mininet/dts/dts-client_old/converter.py h1-eth1 server1 wor1 55555 4551 &
echo "Initiating IP<->DTS converter...done"

sleep 4

echo "Initiating video cvlc..."
clvc /home/mininet/dts/dts-client_old/video.mp4 --sout '#rtp{dst=127.0.0.1,port=55555,mux=ts,ttl=5}'
